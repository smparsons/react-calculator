...
interface PercentagePressedAction {
  type: typeof PERCENTAGE_PRESSED
}
...
export const percentagePressed = (): PercentagePressedAction => ({
  type: PERCENTAGE_PRESSED
})
